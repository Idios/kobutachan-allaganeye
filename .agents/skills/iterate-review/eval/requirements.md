...
4. **[critical]** **J-4**: **Final summary comment (Step 4)** — 収束時に 1 回だけ投稿する summary comment であり、Step 2.3 の per-round Round summary AskUserQuestion とは別物 — に「Codex fallback notice」必須記載 (Iron Law 5 整合) するか
