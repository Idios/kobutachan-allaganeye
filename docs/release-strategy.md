...
| L3: メタデータ化 | 0.3.0 | `v0.3.0` | 2026-04-25 |
| L4: 価値評価 | 0.4.0 | `v0.4.0` | 2026-05-02 |
| L5: 自動編集 | 0.5.0 | `v0.5.0` | 2026-05-16 |
...
|---|---|---|---|---|
| L6: guard 連携 | 0.6.0 | `v0.6.0` | 2026-05-23 | allaganeye-guard 統合 (`--verify`)、exit code 6 追加 |
| L7: 配布 | 0.7.0 | `v0.7.0` | 2026-05-30 | ゼロ環境構築配布 (#106) |
| L8: プライバシー・精密分割 | 0.8.0 | `v0.8.0` | 2026-06-06 | プレイヤー名ぼかし (#63)、再エンコード分割 (#28) |
