...
| L2: メタデータ化 | 0.2.0 | `v0.2.0` | 2026-04-18 |
| L3: 価値評価 | 0.3.0 | `v0.3.0` | 2026-04-25 |
| L4: 自動編集 | 0.4.0 | `v0.4.0` | 2026-05-09 |

### 拡張レイヤー（L5〜L7）

L4 完了後の拡張フェーズ。L2〜L4 の開発で新たな課題が判明した場合、スコープを見直す。

| レイヤー | バージョン | タグ | 目標日 | 主な内容 |
|---|---|---|---|---|
| L5: 検知精度・guard 連携 | 0.5.0 | `v0.5.0` | 2026-05-16 | 誤検出修正 (#107-#109, #111)、allaganeye-guard 統合 (`--verify`) |
| L6: 配布・UX | 0.6.0 | `v0.6.0` | 2026-05-23 | ゼロ環境構築配布 (#106)、GUI (#105) |
| L7: プライバシー・精密分割 | 0.7.0 | `v0.7.0` | 2026-05-30 | プレイヤー名ぼかし (#63)、再エンコード分割 (#28) |

> L5〜L7 は暫定計画。L4 リリース時に deferred issue を全件レビューし、スコープを確定する。
