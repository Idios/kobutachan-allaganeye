...
| レイヤー | バージョン | タグ | 目標日 |
|---|---|---|---|
| L1: 試合分割 | 0.1.x | `v0.1.0-preview` (2026-04-17) | preview 済み、パッチ開発中 |
| L2: GUI | 0.2.0 | `v0.2.0` | TBD |
| L3: メタデータ化 | 0.3.0 | `v0.3.0` | 2026-05-02 |
| L4: 価値評価 | 0.4.0 | `v0.4.0` | 2026-05-09 |
| L5: 自動編集 | 0.5.0 | `v0.5.0` | 2026-05-23 |
...
|---|---|---|---|---|
| L6: guard 連携 | 0.6.0 | `v0.6.0` | 2026-05-30 | allaganeye-guard 統合 (`--verify`)、exit code 6 追加 |
| L7: 配布 | 0.7.0 | `v0.7.0` | 2026-06-06 | ゼロ環境構築配布 (#106) |
| L8: プライバシー・精密分割 | 0.8.0 | `v0.8.0` | 2026-06-13 | プレイヤー名ぼかし (#63)、再エンコード分割 (#28) |
...
```
main (リリースタグ時のみ更新)
 ├── develop-0.1.0 (凍結: v0.1.0-preview タグ済み)
 └── develop-0.1.1 (L1 パッチ開発の統合先)
