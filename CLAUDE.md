...
| `gui/src/state/` | Zustand store (`appStateStore` = screen + selection + detectionParams / `metadataStore` = load/apply/restore/loadSample / `recentStore` = `~/.allaganeye/recent.json` 履歴 #571) |
